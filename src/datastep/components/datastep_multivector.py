...
def get_hypothetical_questions(docs):
    ...
    chain = (
        ...
        | ChatOpenAI(max_retries=6, model="gpt-3.5-turbo-1106", request_timeout=10, openai_api_base=OPENAI_API_BASE).bind(
                functions=functions,
...
def get_retriever_qa(retriever):
    ...
    return RetrievalQA.from_chain_type(
        llm=ChatOpenAI(model_name="gpt-3.5-turbo-16k", openai_api_base=OPENAI_API_BASE),
        chain_type="stuff",
