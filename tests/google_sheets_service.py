...
CREDENTIALS_PATH = os.path.join(os.path.dirname(__file__), '..', 'datastep-excel-for-classifier-66a610dc9ff6.json')

TEST_CASES_TABLE_HEADERS = ['Тест-Кейс ID', 'Шаг алгоритма', 'Тип ошибки', 'Номенклатура поставщика', 'Ожидание номенклатура', 'Ожидание группа']
...
def create_new_sheet_and_write_results(new_sheet_name, processed_results):
    ...
    headers = ['Тест-Кейс ID', 'Шаг алгоритма', 'Тип ошибки', 'Корректно?', 'Номенклатура', 'Ожидание группа', 'Реальность группа', 'Ожидание номенклатура', 'Реальность номенклатура']
